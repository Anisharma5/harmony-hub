    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Complete overview of your school</p>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ${(stats?.monthlyFeeCollection || 0).toLocaleString()}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats?.todayAttendanceRate || 0}%</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats?.recentPaymentsCount || 0}</div>
            <p className="text-xs text-muted-foreground">This month</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats?.activeNotices || 0}</div>
