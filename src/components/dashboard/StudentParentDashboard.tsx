...
import { TrendingUp, ClipboardCheck, DollarSign, Bell } from 'lucide-react';

export const StudentParentDashboard = () => {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Student Dashboard</h1>
        <p className="text-muted-foreground">Your academic progress and fees</p>
      </div>
